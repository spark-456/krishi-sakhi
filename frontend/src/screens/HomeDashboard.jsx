                ...
                <div className="bg-white/15 backdrop-blur-md border border-white/20 rounded-2xl p-4 relative z-10">
                    <div className="flex justify-between items-center mb-4">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-semibold text-sm">Farm 1 (Wheat)</span>
                        </div>
                ...
                <section>
                    ...
                    <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-100">
                        <div className="flex justify-between items-center border-b border-slate-100 pb-4 mb-4">
                            <div>
                                <p className="text-sm font-medium text-slate-500">Current Crop Route</p>
                                <h4 className="text-lg font-bold text-slate-800">Wheat (HD 2967)</h4>
                            </div>
                            <div className="text-right">
                                <p className="text-sm font-medium text-slate-500">Stage</p>
                                <span className="inline-block bg-blue-50 text-blue-600 text-xs font-bold px-2.5 py-1 rounded-md mt-0.5">Vegetative</span>
                            </div>
                        </div>

                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <p className="text-xs font-medium text-slate-500 mb-1">Next Action</p>
                                <p className="text-sm font-semibold text-slate-700">Apply Urea Fertilizer</p>
                                <p className="text-xs text-primary font-medium mt-1">Due in 2 days</p>
                            </div>
                            <div className="border-l border-slate-100 pl-4">
                                <p className="text-xs font-medium text-slate-500 mb-1">Soil Moisture</p>
